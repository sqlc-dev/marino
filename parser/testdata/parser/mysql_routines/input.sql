...
-- case
CREATE DEFINER = u@h PROCEDURE p (IN a INT, OUT b VARCHAR(10), INOUT c BIGINT) COMMENT 'c' LANGUAGE SQL NOT DETERMINISTIC CONTAINS SQL SQL SECURITY DEFINER SELECT 1
-- case
...
$$
-- case
CREATE FUNCTION js_q(s VARCHAR(64)) RETURNS VARCHAR(128) LANGUAGE JAVASCRIPT DETERMINISTIC NO SQL AS $body$
  return "got: " + s;
$body$
-- case
