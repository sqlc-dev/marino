...
-- case
CREATE TABLE t (gc GEOMCOLLECTION)
-- case
...
-- case
CREATE TABLE t (g GEOMETRY NOT NULL SRID 4326, SPATIAL INDEX idx_g (g))
-- case
CREATE TABLE t (g GEOMETRY NOT NULL, SPATIAL KEY (g))
-- case
CREATE TABLE t (g GEOMETRY NOT NULL, SPATIAL (g))
-- case
ALTER TABLE t ADD SPATIAL INDEX idx_g (g)
-- case
...
-- case
SELECT CAST(x AS GEOMETRY), CAST(x AS GEOMETRYCOLLECTION), CAST(x AS GEOMCOLLECTION) FROM t
-- case
