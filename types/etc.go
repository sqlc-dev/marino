...
var str2Type = map[string]byte{
	...
	"point":              mysql.TypePoint,
	"linestring":         mysql.TypeLineString,
	"polygon":            mysql.TypePolygon,
	"multipoint":         mysql.TypeMultiPoint,
	"multilinestring":    mysql.TypeMultiLineString,
	"multipolygon":       mysql.TypeMultiPolygon,
	"geometrycollection": mysql.TypeGeometryCollection,
